...
import 'package:akilli_alisveris/consts/app_constants.dart';
import 'package:akilli_alisveris/widgets/products/ctg_rounded_widget.dart';
import 'package:akilli_alisveris/widgets/products/latest_arrival.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Visibility(
                ...
                child: const TitlesTextWidget(label: "Son Gelenler"),
              ),
              const SizedBox(
                height: 15.0,
              ),
